...
CORE_OBJS = ds4.o ds4_distributed.o ds4_ssd.o ds4_expert_swap.o ds4_metal.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_ssd.o ds4_expert_swap.o
else
...
CORE_OBJS = ds4.o ds4_distributed.o ds4_ssd.o ds4_expert_swap.o ds4_cuda.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_ssd.o ds4_expert_swap.o
...
strix-halo:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-eval ds4-agent \
		CORE_OBJS="ds4.o ds4_distributed.o ds4_ssd.o ds4_expert_swap.o ds4_rocm.o" \
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_expert_swap.h ds4_distributed.h ds4_gpu.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c

ds4_ssd.o: ds4_ssd.c ds4_ssd.h
	$(CC) $(CFLAGS) -c -o $@ ds4_ssd.c

ds4_expert_swap.o: ds4_expert_swap.c ds4_expert_swap.h
	$(CC) $(CFLAGS) -c -o $@ ds4_expert_swap.c

ds4_cli.o: ds4_cli.c ds4.h ds4_ssd.h ds4_expert_swap.h ds4_distributed.h ds4_help.h linenoise.h
